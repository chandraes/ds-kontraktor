        ...
        <table class="table table-hover table-bordered" ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle table-pdf text-pdf">{{$d->kode }}</td>
                    ...
                    <td class="text-end align-middle table-pdf text-pdf text-danger">{{$d->jenis === 0 ?
                        number_format($d->nominal, 0, ',', '.') : ''}}
                    </td>
                    <td class="text-end align-middle table-pdf text-pdf">{{number_format($d->saldo, 0, ',', '.')}}</td>
